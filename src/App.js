...
function App() {
  ...
  { id: 8,  numero: "19", depart: "Liberte 6",           arrivee: "Dieuppeul",   arrets: 13, couleur: "#1abc9c" },
  { id: 9,  numero: "5",  depart: "Sicap Mbao",          arrivee: "Medina",      arrets: 15, couleur: "#d35400" },
  { id: 10, numero: "31", depart: "HLM Grand Yoff",      arrivee: "Plateau",     arrets:  8, couleur: "#2c3e50" },
];
  return (
    <div className="App">
      <Header />
